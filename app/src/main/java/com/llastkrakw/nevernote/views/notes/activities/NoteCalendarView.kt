...
class NoteCalendarView : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        noteWithFolders = intent?.getParcelableExtra(NoteAdapter.NOTE_EXTRA)
        ...
        binding.validateDate.setOnClickListener {
            ...
            if(selectedDate == null){
                ...
                noteWithFolders?.let { it1 -> NoteTimePickerFragment(noteViewModel, it1, selectedDate!!.toEpochDay()).show(supportFragmentManager, "Select hour of reminder") }
            }
        }
    }
    ...
    inner class DayViewContainer(view: View) : ViewContainer(view) {
        ...
        init {
            view.setOnClickListener {
                this@NoteCalendarView.playUiSong(TAP_SONG)
